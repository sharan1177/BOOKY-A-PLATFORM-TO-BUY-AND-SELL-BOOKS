...
<div id="quick_look" class="modal fade" role="dialog">
    ...
    <?php 
        ...
        $contactQuery1 = "SELECT contact_no FROM contacts WHERE username = '{$username}'";
        ...
        if (isset($_POST['order'])) {
            $message = "{$username} is interested in buying {$book_name} , Preferred payment method: {$payment_method} , Buyer Contact No: {$contactNo1}";
