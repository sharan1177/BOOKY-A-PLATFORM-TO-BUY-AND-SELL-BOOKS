...
<?php
    if(isset($_POST['submit'])){
        ...
        $query = "CALL addUser('$username','$hash_password','$user_email','$user_firstName','$user_middleName','$user_lastname','$user_category','$user_role',$user_contact,'$date')";
                ...
                <div class="col-sm-6">
                   <div class='form-group'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                  <label for="preference">Your Branch</label>
