...
<nav class="navbar navbar-inverse" id="navbar" style="border-bottom: 2px solid black;margin-bottom:0px;">
    <div class="container-fluid">
      <div class="navbar-header">
         <a href="index.php" style="padding:10px;"><i id="website-name" style="margin-top: 0px;"><img src="includes/images/booky2.png" style="top: 0px; height: 25px;"></i></a> 
      </div>
                                ...
                                <div class="container">
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h4 class="media-heading" style="color: black;"><b>'.$bookName.'</b>&nbsp;</h4>
                                      <div class="price">
